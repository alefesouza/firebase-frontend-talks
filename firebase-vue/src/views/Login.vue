    ...
    <div class="mdl-grid">
        <div class="mdl-card mdl-shadow--2dp mdl-cell mdl-cell--12-col mdl-cell--6-col-tablet mdl-cell--1-offset-tablet mdl-cell--6-col-desktop mdl-cell--3-offset-desktop">
            ...
            <div class="mdl-card__supporting-text">
                ...
                <button class="mdl-button mdl-js-button mdl-button--raised login-with" id="login-facebook" @click="loginWith('facebook')">
                    Login with Facebook
                </button>

                <button class="mdl-button mdl-js-button mdl-button--raised login-with" id="login-github" @click="loginWith('github')">
                    Login with GitHub
                </button>
            </div>
